...
Determine the balance domain from the task. If the task implies a domain
(see below) use it; otherwise infer it from any file path given, or ask the user
via `ask_user_question` which system to check.

...
**Focus:** determine from the task (default `full`). If the task does not state a
focus, use `full` or confirm via `ask_user_question`.

- **`full` (default)**: Both consistency and design theory passes

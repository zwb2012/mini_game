...
If no argument: `ask_user_question`:
...
Present to user: "I mapped [N] components from the UX spec. Does this look right?" Use `ask_user_question`: `[A] Looks good` / `[B] Adjust mapping`

...
After all epics for the current layer are defined (Step 4 completed for all in-scope systems), and before writing any files, spawn `producer` via subagent using gate **PR-EPIC** (`.claude/docs/director-gates.md`).

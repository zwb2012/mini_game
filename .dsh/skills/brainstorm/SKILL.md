...
**After identifying biggest technical risks, spawn `technical-director` via subagent using gate TD-FEASIBILITY (`.claude/docs/director-gates.md`) before scope tiers are defined.**
...
**After scope tiers are defined, spawn `producer` via subagent using gate PR-SCOPE (`.claude/docs/director-gates.md`).**

...
After decomposing all stories (Step 4 complete) but before presenting them for write approval, spawn `qa-lead` via subagent using gate **QL-STORY-READY** (`.claude/docs/director-gates.md`).

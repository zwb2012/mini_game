...
Validates `.dsh/skills/*/SKILL.md` files for structural compliance and
...
- `static all` → run 7 structural checks on all skills (Glob `.dsh/skills/*/SKILL.md`)
...
Glob `.dsh/skills/*/SKILL.md` to get the complete list of skills.

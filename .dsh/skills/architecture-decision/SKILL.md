...
5.5. **Engine Specialist Validation** — Before saving, spawn the **primary engine specialist** via subagent to validate the drafted ADR:
...
5.6. **Technical Director Strategic Review** — After the engine specialist validation, spawn `technical-director` via subagent using gate **TD-ADR** (`.claude/docs/director-gates.md`):

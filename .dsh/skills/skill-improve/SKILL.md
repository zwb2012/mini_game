...
Verify `.dsh/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.dsh/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.dsh/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.dsh/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.dsh/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .dsh/skills/[name]/SKILL.md`
